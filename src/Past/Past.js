...
class Past extends Component {
      constructor () {
        ...
        this.getUSDPrices = this.getUSDPrices.bind(this);
        this.getEURPrices = this.getEURPrices.bind(this);
      ...
      // This function gets the USD price for a specific timestamp/date. The date is passed in as an argument
      getUSDPrices (date) {
          return axios.get('https://min-api.cryptocompare.com/data/pricehistorical?fsym=USD&tsyms=USD&ts=' + date);
      }
      // This function gets the EUR price for a specific timestamp/date. The date is passed in as an argument
      getEURPrices (date) {
          return axios.get('https://min-api.cryptocompare.com/data/pricehistorical?fsym=EUR&tsyms=USD&ts=' + date);
      }
    ...
    getTodayPrice () {
        ...
        axios.all([this.getUSDPrices(t), this.getEURPrices(t), this.getETHPrices(t), this.getBTCPrices(t), this.getLTCPrices(t)])
            .then(axios.spread((usd, eur, eth, btc, ltc) => {
                let f = {
                    date: moment.unix(t).format("MMMM Do YYYY"),
                    usd: usd.data.USD.USD,
                    eur: eur.data.EUR.USD,
                    ...
                    <div className="history--section container">
                        ...
                        <div className="history--section__box">
                            <div className="history--section__box__inner">
                                ...
                                <div className="columns">
                                    <div className="column">
                                        <p>1 USD = ${this.state.todayprice.usd}</p>
                                    </div>
                                    <div className="column">
                                        <p>1 EUR = ${this.state.todayprice.eur}</p>
                                    </div>
                                    <div className="column">
                            ...
                            <div className="history--section__box__inner">
                                ...
                                <div className="columns">
                                    <div className="column">
                                        <p>1 USD = ${this.state.yesterdayprice.usd}</p>
                                    </div>
                                    <div className="column">
                                        <p>1 EUR = ${this.state.yesterdayprice.eur}</p>
                                    </div>
                                    <div className="column">
                            ...
                            <div className="history--section__box__inner">
                                ...
                                <div className="columns">
                                  <div className="column">
                                    <p>1 USD = ${this.state.twodaysprice.usd}</p>
                                    </div>
                                    <div className="column">
                                      <p>1 EUR = ${this.state.twodaysprice.eur}</p>
                                    </div>
                                    <div className="column">
                            ...
                            <div className="history--section__box__inner">
                                ...
                                <div className="columns">
                                    <div className="column">
                                      <p>1 USD = ${this.state.threedaysprice.usd}</p>
                                    </div>
                                    <div className="column">
                                      <p>1 EUR = ${this.state.threedaysprice.eur}</p>
                                    </div>
                                    <div className="column">
                            ...
                            <div className="history--section__box__inner">
                                ...
                                <div className="columns">
                                    <div className="column">
                                      <p>1 USD = ${this.state.fourdaysprice.usd}</p>
                                    </div>
                                    <div className="column">
                                      <p>1 EUR = ${this.state.fourdaysprice.EUR}</p>
                                    </div>
                                    <div className="column">
